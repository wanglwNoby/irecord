...
class FileDeleteInfo extends React.Component<any, any> {
    ...
    public render(): React.ReactElement {
        ...
        return (
            <div style={{ height: '650px', overflow: 'auto' }}>
                <div style={{ marginTop: '15px', marginLeft: '30px', textAlign: 'center' }}>{intl.get('M26P102261011090500PF004').d('归档回删服务信息')}</div>
                <div>
                    <Row style={{ marginTop: '15px', marginLeft: '30px', borderBottom: '1px solid #2C3E50', padding: '8px' }}>
                        <Col span={8}>
                            {intl.get('M26P102261011090500ML023').d('归档回删服务别名')}
                        </Col>
                        <Col span={16}>
