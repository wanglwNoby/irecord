...
// 左侧菜单
export function _getLeftMenu(): Promise<AxiosResponse<any>> {
...
// 获取下拉框单选等语言包
export function _getOptionLangs(params: IOptionLangs): Promise<AxiosResponse<any>> {
    return axios.get('/record_config/get_language', params)
}

// 根据类型获取下拉语言包数据
export function _getOptionLang(params: IGetOptionLang): Promise<AxiosResponse<any>> {
